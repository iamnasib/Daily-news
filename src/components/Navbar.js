...
const Navbar = (props) => {
  ...
  return (
    <>
      {" "}
      <nav className="bg-white border-gray-200 dark:bg-gray-900 fixed top-0 w-full z-50 shadow-lg dark:border-gray-700">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link
            to="/"
            className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="/logo512.png" className="h-8" alt="Flowbite Logo" />
            ...
            <div className="block">
              {props.darkMode ? (
                ...
                <svg width="30" height="30" id="dark-icon">
                  <path
                    fill={`${
                      props.darkMode === true ? "CurrentColor" : "black"
                    }`}
                    d="
                M 23, 5
                A 12 12 0 1 0 23, 25
